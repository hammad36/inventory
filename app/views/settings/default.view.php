<main class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <div class="divide-y divide-gray-200">
            ...
            <!-- Privacy settings -->
            <div class="p-6 hover:bg-gray-50 transition duration-200 flex items-center justify-between">
                <a href="/settings/privacy" class="text-blue-600 hover:text-blue-800 transition">
                    <div>
            ...
            <!-- Notifications -->
            <div class="p-6 hover:bg-gray-50 transition duration-200 flex items-center justify-between">
                <a href="/settings/notifications" class="text-blue-600 hover:text-blue-800 transition">
                    <div>
                        <h2 class="text-lg font-semibold text-gray-800">Notification Preferences</h2>
                        <p class="text-sm text-gray-500">Manage how you receive updates</p>
                    </div>
                    <a href="/settings/notifications" class="text-blue-600 hover:text-blue-800 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
